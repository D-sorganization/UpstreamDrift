...
class StrategyComparisonService:
    ...
    def compare_strategies(
        ...
        for pkg in packages:
            ...
            marker_rmse = kin_report.metrics.get("marker_rmse_mm")
    ...
    def extract_tracking_and_closure_errors(
        ...
        for pkg in packages:
            ...
            errors[key] = {
                "strategy_id": pkg.strategy.strategy_id,
                "whole_marker_rmse_mm": kin_report.metrics.get("marker_rmse_mm"),
                "max_equilibrium_residual": force_report.metrics.get("max_residual"),
