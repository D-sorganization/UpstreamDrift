...
# Documented default path used by MachineLearning / surrogate extractors.
# REVIEW.md and TURNOVER.md established this path is frequently absent on
# developer hosts; NM-00 records absence explicitly instead of inventing results.
