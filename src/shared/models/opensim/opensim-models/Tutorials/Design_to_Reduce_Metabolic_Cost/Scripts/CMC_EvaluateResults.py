...
resultsFolderCMC = utils.FileUtils.getInstance().browseForFolder(
    "Select the folder with CMC Results", 1
)
...
src = addDataSource(
    residualForcePlot, resultsFolderCMC + "/walk_subject_Actuation_force.sto"
)
...
src = addDataSource(
    reserveForcePlot, resultsFolderCMC + "/walk_subject_Actuation_force.sto"
)
