...
- _Note: Visual overlays require OpenCV (opencv-python). If not installed, functionality works without visuals._
...
3. _Optional_: **Save the pose** for later reuse
...
_Note: Visual feedback is optional - drag functionality works without it_
...
_Performance may vary based on hardware_
