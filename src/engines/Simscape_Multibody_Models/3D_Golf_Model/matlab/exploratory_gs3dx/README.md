...
| `tools/gs3dx_build_quat.m`        | Builds `GS3DX_Quat` plus `GS3DX_KDS_Spherical` (quaternion shoulders)          |
...
| `GS3DX_Quat`     | `gs3dx_build_quat`     | Spherical (quaternion) shoulders: 10 fewer blocks (609 → 599) |
...
under `gs3dx_pinned_drive` and on the isolated joint rig; see
