...
<!-- BEGIN GENERATED PARITY MATRIX (MS-70 #10350 / MS-71 #10351) -->

Authoritative cross-engine evaluation is generated by `src/shared/python/motion_matching/parity_report.py` and validated against candidate evidence in `evidence/matched/driver_g1/parity_report.md`.

| Engine        | Comparison Class        | Plant Architecture       | Kinematic Verification | Dynamics Replay                 | Status              |
| :------------ | :---------------------- | :----------------------- | :--------------------- | :------------------------------ | :------------------ |
| **MuJoCo**    | Same-Model Numerical    | `MujocoMatchingPlant`    | ✅ Full-body MJCF      | 🟡 G1 reevaluation              | **In Verification** |
| **Drake**     | Same-Model Numerical    | `DrakeMatchingPlant`     | ✅ MultibodyPlant      | 🟡 Trajectory optimization      | **In Verification** |
| **Pinocchio** | Same-Model Numerical    | `PinocchioMatchingPlant` | ✅ URDF / Pink IK      | 🟡 Crocoddyl / G1 rollout       | **In Verification** |
| **OpenSim**   | Native-Model Observable | `OpensimMatchingPlant`   | ✅ IK / MocoTrack      | 🟡 Anatomical sub-epic (#10394) | **In Verification** |
| **MyoSuite**  | Native-Model Observable | `MyoSuiteMatchingPlant`  | 🟡 `myo_sim` scene     | 🟡 Muscle excitation            | **Development**     |
