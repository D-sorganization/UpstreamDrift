...
try:
    ...
    class MplCanvas:  # type: ignore[no-redef]
        ...
        to ensure compatibility when Qt is unavailable (e.g., in headless CI envs).
        """
        ...
        def __init__(self, width=8, height=6, dpi=100) -> None:  # noqa: ARG002
            ...
            Args:
                width: Figure width in inches (unused, kept for signature compat)
                height: Figure height in inches (unused, kept for signature compat)
                dpi: Dots per inch for rendering (unused, kept for signature compat)
