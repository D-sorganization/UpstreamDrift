...
class TestConstants:
    ...
    def test_mathematical_constants(self) -> None:
        ...
        assert math.isclose(math.pi, constants.PI, rel_tol=1e-15)
        assert math.isclose(2.718281828459045, constants.E, rel_tol=1e-15)
    ...
    def test_conversion_factors(self) -> None:
        ...
        assert math.isclose(speed_kph, 36.0, rel_tol=1e-10)
        assert math.isclose(speed_mph, 22.3694, rel_tol=1e-10)
        ...
        assert math.isclose(angle_rad, math.pi, rel_tol=1e-10)
        assert math.isclose(angle_deg_back, 180.0, rel_tol=1e-10)
