...
addpath(genpath('matlab/Integrated_Analysis_App'));
...
```matlab
addpath('matlab/2D GUI/visualization');
```
...
- Implementation Plan: `docs/TABBED_GUI_IMPLEMENTATION_PLAN.md` (if exists)
- Signal Plotter Guide: `docs/INTERACTIVE_SIGNAL_PLOTTER_GUIDE.md` (if exists)
- Original visualization: `matlab/2D GUI/visualization/`
- Default data files: `matlab/Skeleton Plotter/`
