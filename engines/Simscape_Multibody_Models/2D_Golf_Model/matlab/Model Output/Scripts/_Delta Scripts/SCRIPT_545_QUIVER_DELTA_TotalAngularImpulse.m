...
TotalAngularImpulse=DELTAQ.LWAngularImpulseonClub+DELTAQ.RWAngularImpulseonClub;
...
%Save Figure
savefig('Delta Quiver Plots/DELTA_Quiver Plot - Total Angular Impulse on Club');
pause(PauseTime);
