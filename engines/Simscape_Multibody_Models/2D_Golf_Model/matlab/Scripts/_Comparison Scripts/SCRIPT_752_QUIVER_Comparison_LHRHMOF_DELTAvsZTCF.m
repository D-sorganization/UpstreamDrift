...
LWSumofMomentsQuiver=quiver3(BASEQ.LWx(:,1),BASEQ.LWy(:,1),BASEQ.LWz(:,1),DELTAQ.LHMOFonClubGlobal(:,1),DELTAQ.LHMOFonClubGlobal(:,2),DELTAQ.LHMOFonClubGlobal(:,3));
...
RWSumofMomentsQuiver=quiver3(BASEQ.RWx(:,1),BASEQ.RWy(:,1),BASEQ.RWz(:,1),DELTAQ.RHMOFonClubGlobal(:,1),DELTAQ.RHMOFonClubGlobal(:,2),DELTAQ.RHMOFonClubGlobal(:,3));
...
%Add Legend to Plot
legend('','','','','DELTA - LW Moment of Force','DELTA - RW Moment of Force','ZTCF - LW Moment of Force','ZTCF - RW Moment of Force');

%Add a Title
title('LW and RW Moment of Force DELTA vs. ZTCF');
subtitle('COMPARISON');
...
%Save Figure
savefig('Comparison Quiver Plots/COMPARISON_Quiver Plot - LWRW Moment of Force Delta vs ZTCF');
pause(PauseTime);
