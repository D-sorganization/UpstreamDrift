...
class TestVerification(unittest.TestCase):
    def test_mujoco_analyzer(self):
        try:
            import mujoco
            from engines.physics_engines.mujoco.python.mujoco_humanoid_golf.biomechanics import BiomechanicalAnalyzer
    ...
    def test_pinocchio_analyzer(self):
        try:
            ...
            from engines.physics_engines.pinocchio.python.pinocchio_golf.induced_acceleration import InducedAccelerationAnalyzer
    ...
    def test_drake_analyzer(self):
        try:
            ...
            # If installed:
            from engines.physics_engines.drake.python.src.drake_gui_app import DrakeInducedAccelerationAnalyzer
