...
try:
    ...
    class OutputManager:
        ...
        def save_simulation_results(self, results, filename, format_type=OutputFormat.CSV):
            pass
...
class TestOutputManager:
    ...
    def test_save_json_results(self, temp_dir):
        ...
        # Verify file was created and content is correct (should be in mujoco subdirectory)
        output_file = temp_dir / "simulations" / "mujoco" / filename
        assert output_file.exists()
    ...
    def test_load_simulation_results(self, temp_dir, sample_swing_data):
        ...
        # Load it back
        loaded_data = manager.load_simulation_results(
            filename,
            OutputFormat.CSV
        )
...
class TestOutputManagerErrors:
    ...
    def test_load_nonexistent_file(self, temp_dir):
        ...
        with pytest.raises(FileNotFoundError):
            manager.load_simulation_results(
                "nonexistent.csv",
                OutputFormat.CSV
            )