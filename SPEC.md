...
| 2026-09-11 | #0000 | Replaced np.linalg.norm with np.sqrt(np.einsum) in tour_fit_state.py to optimize multidimensional array summation. (spec-exempt: micro-optimization) |
