...
| 2026-09-10 | #9907 | Guided capture outcomes share validated prerequisite metadata with the capability atlas; standard Qt navigation reuses editors and readiness, preserves capture-owned progress, checks calibration/model associations and imports safe map selections. Epic #9906; PR number follows publication. |
