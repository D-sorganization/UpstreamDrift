...
| 2026-09-08 | #9825 | Preserve reviewed outcomes, numeric evidence and claim order through actual manufactured registration; refuse changed science before mutation, restore required provenance tests, regenerate deterministic native evidence with unchanged numerical results, and refresh the reviewed census/PDF and governed release records. |
