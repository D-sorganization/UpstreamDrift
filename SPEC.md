...
| Date       | PR         | Changes    |
| ---------- | ---------- | ---------- |
| 2026-09-10 | #9959 | Bind capture reconstruction to selected calibration bytes, verify source stability during processing, and require reconstruction again after calibration changes or missing legacy lineage. Preserve earlier results and use existing wizard prerequisite links for downstream models. |
