...
| Date       | PR         | Changes    |
| ---------- | ---------- | ---------- |
| 2026-09-10 | #9898 | Extend zoom-aware profile review with capture-owned paper/ruler placements, original-frame point editing, repeated revisions, isolated canonical Tools layout estimation, reviewed result history, guided cross-capture reuse with portable evidence and processing checks, generated help and distortion-preserving reconstruction. Numerical inventory remains blocked under #9900; final shared-provider pin and physical qualification remain pending. |
