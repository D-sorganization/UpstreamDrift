...
| 2026-09-09 | #9860 | Non-destructive per-view swing trim/crop recipes, original-pixel and source-clock-preserving inference, native preview/editor, downstream timeline regression and portable library backend with notes/archive/storage/rename/copy; library UI and advanced reference work remain in progress under #9849/#9863. |
