...
| Date | PR | Changes |
| --- | --- | --- |
| 2026-09-12 | #8866 | Remove the unwired per-engine and observed-input skeleton extractors (drake, mujoco, pinocchio, opensim, mediapipe, openpose) from src/tools/starting_pose_matcher until #4367 dispatches them through pose_interchange; the matcher stays honestly single-engine (Simscape JSON). |
