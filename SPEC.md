...
| 2026-09-08 | #9787 | Restore manufactured-authority binary compatibility while preserving pinned scientific engines; initialize the exact Tools provider in native lanes, regenerate actual deterministic source/provenance evidence, preserve reviewed claim outcomes and numeric evidence during refresh, and protect canonical bytes from generic formatting. |
