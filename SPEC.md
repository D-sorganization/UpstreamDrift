...
| Date       | PR         | Changes    |
| ---------- | ---------- | ---------- |
| 2026-09-09 | #9864 | Add validated expert reference assets and a native library: C3D/shared model marker imports, explicit units/axes/joint mapping, masked samples, source hashes, separate 2D video kind, notes/archive and background I/O. Reuse existing Rust-preferred C3D adapter and correct fallback residual handling. Registration and projection remain in #9865/#9866. |
