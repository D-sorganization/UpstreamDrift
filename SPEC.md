...
| Date       | PR         | Changes    |
| ---------- | ---------- | ---------- |
| 2026-09-10 | #9950 | Restore installed Capture Rig startup by preserving reference-loader packaging and resolving the owning bundled calibration provider. Default new recordings to unique player-library destinations and preserve existing takes. Installed and source regression evidence is recorded separately from physical-camera qualification. |
| 2026-09-10 | #9946 | Deliver reviewed common-reference calibration sessions, original-frame marking, repeated placements, result review and named library reuse. Preserve optical settings and distortion through consumers; provide guided prerequisite recovery, saved routes and player help. Integrate the published shared provider. Physical-camera qualification remains separate. |
