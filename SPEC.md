...
| Date       | PR         | Changes    |
| ---------- | ---------- | ---------- |
| 2026-09-09 | #9856 | Generate source-backed capability/workflow maps and searchable offline atlas linked from the launcher.  Required code-quality CI also checks atlas freshness independently of changed-test selection. |
