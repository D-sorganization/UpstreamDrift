...
- **Club-Only Epic:** [#10602](https://github.com/D-sorganization/UpstreamDrift/issues/10602); CO-00/#10667, CO-01/#10670, CO-02/#10675 shipped; active [CO-03 #10607](https://github.com/D-sorganization/UpstreamDrift/issues/10607) on `feat/10607-co03-retrieval-constrained-ik`.
...
- **State:** CO-03 retrieval + constrained-IK starting guesses implemented (synthetic fixtures + workbook smoke); kinematic preview only. NM-00 fail-closed audit remains authoritative.
- **Next:** Open/land CO-03 PR #10607; then dispatch CO-04 #10608.
