...
- PR #9826 native/rolling/publication CI passes at e93ef5224. Unit CI finds stale PDF regression constants; reproduced RED and corrected to the reviewed artifact, with all 11 publication tests passing. Independent optional-stack failure: multiple-shooting reference position defect 0.519081 exceeds 0.5 in unchanged #9768 code; investigate separately without relaxing acceptance. Follow claim_preservation_9825_turnover.md before delivery/merge.
