...
- #9787 / PR #9804: current CI found one stale reviewer summary after 14,109 unit passes. Canonical JSON/CSV/QMD and the 253-page PDF are regenerated; all five summary tests pass and claim outcomes remain unchanged. The native record retains its 355157bd SHA; 116 strict native and three rolling tests previously pass. See `docs/development/manufactured_authority_9787_turnover.md`; protected CI remains required.
