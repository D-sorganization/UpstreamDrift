...
- PR [#10740](https://github.com/D-sorganization/UpstreamDrift/pull/10740) carries the source-clock and capture-plane contract. It remains intentionally narrow so fixed marker attachments and feasible initial-state calibration can be reviewed independently.
...
- Next step: calibrate fixed geometry, q0/v0, and marker attachments against both source clocks, then save diagnostic receipts without promoting either capture before qualification.
