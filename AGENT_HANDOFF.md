...
- **Club-Only Epic:** [#10602](https://github.com/D-sorganization/UpstreamDrift/issues/10602); CO-00 through CO-08 shipped on main; active [CO-09 #10613](https://github.com/D-sorganization/UpstreamDrift/issues/10613) on `feat/issue-10613-co09-ui` (UI + results integration).
...
- **State:** CO-09 wires Club-Only Excel into Motion Matching UI/results with matrix `status==scored` verified gating and observed-versus-inferred legend (no parallel store). NM-00 fail-closed audit remains authoritative.
- **Next:** Land CO-09 PR for #10613; then CO-10 (#10614) reproduction guide.
