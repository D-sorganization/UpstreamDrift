...
- PR [#10740](https://github.com/D-sorganization/UpstreamDrift/pull/10740) carries the source-clock, planarity lower-bound, and campaign-receipt contracts. Its reproducible Driver and Iron receipts under `docs/plans/tour_baselines/evidence/` record 110.4 mm and 112.7 mm irreducible normal RMSE, respectively, above the profile 55 mm 3D marker ceiling; both outcomes are rejected and indexed in `reports/matched_swing_ledger.json`.
