...
AIR_DENSITY_SEA_LEVEL_KG_M3 = PhysicalConstant(1.225, "kg/m^3", "ISA Standard Atmosphere", "Air density at sea level, 15C")
ATMOSPHERIC_PRESSURE_PA = PhysicalConstant(101325, "Pa", "ISA Standard Atmosphere", "Standard atmospheric pressure")
UNIVERSAL_GAS_CONSTANT_J_MOL_K = PhysicalConstant(8.314462618, "J/(mol K)", "CODATA 2018", "Molar gas constant")

# Golf-specific constants
GOLF_BALL_MASS_KG = PhysicalConstant(0.04593, "kg", "USGA Rule 5-1", "Maximum golf ball mass (1.620 oz)")
GOLF_BALL_DIAMETER_M = PhysicalConstant(0.04267, "m", "USGA Rule 5-2", "Minimum golf ball diameter (1.680 in)")
GOLF_BALL_DRAG_COEFFICIENT = PhysicalConstant(0.25, "dimensionless", "Bearman & Harvey 1976", "Typical drag coefficient at Re=1.5e5")
GOLF_BALL_LIFT_COEFFICIENT = PhysicalConstant(0.15, "dimensionless", "Bearman & Harvey 1976", "Typical lift coefficient")

# Club specifications
DRIVER_LENGTH_MAX_M = PhysicalConstant(1.1684, "m", "USGA Rule 1-1c", "Max driver length (46 inches)")
DRIVER_LOFT_TYPICAL_DEG = PhysicalConstant(10.5, "degrees", "Modern Trade Average", "Typical driver loft")
...
# Material properties
GRAPHITE_DENSITY_KG_M3 = PhysicalConstant(1750, "kg/m^3", "Materials Handbook", "Typical golf shaft graphite")
...
MAGNUS_COEFFICIENT = PhysicalConstant(0.25, "dimensionless", "Bearman & Harvey", "Magnus effect coefficient")
SPIN_DECAY_RATE_S = PhysicalConstant(0.05, "1/s", "Trackman Data", "Spin decay rate")
AIR_VISCOSITY_KG_M_S = PhysicalConstant(1.789e-5, "kg/(m s)", "ISO 2533", "Dynamic viscosity of air at 15C")
...
# Project Config
MUJOCO_LAUNCHER_SCRIPT: Path = Path("engines/physics_engines/mujoco/python/mujoco_humanoid_golf/advanced_gui.py")
DRAKE_LAUNCHER_SCRIPT: Path = Path("engines/physics_engines/drake/python/src/golf_gui.py")
PINOCCHIO_LAUNCHER_SCRIPT: Path = Path("engines/physics_engines/pinocchio/python/pinocchio_golf/gui.py")
URDF_GENERATOR_SCRIPT: Path = Path("tools/urdf_generator/main.py")
C3D_VIEWER_SCRIPT: Path = Path("engines/Simscape_Multibody_Models/3D_Golf_Model/python/src/apps/c3d_viewer.py")
