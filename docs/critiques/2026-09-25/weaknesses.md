...
strings by slicing a SHA-256 of the *model ID string*:
...
it is absent, the function synthesizes one by multiplying the *candidate's own*
...
- The Surrogate Training Guide (`docs/motion_matching/SURROGATE_TRAINING_GUIDE.md`,
  ...
  *target*, not a measured result. This is the intended real baseline; its
