# Historical Native Matching and Incoming Project Handoffs

Archived chronology. ACTIVE/current-authority statements below are historical,
not live process evidence. Read HANDOFF.md for the sole current status.

## Run57 Terminal and Tight DOP853 Run58 Active

Run57 handle40751 exited0. DOP853 levels33.004/59.728 s,9396/16596 evaluations,
both fail native velocity gate (0.000480899/0.000566066) against tight scalar54
settings. Marker differences8.244e-8/1.130e-7 m and closure pass. Smaller maximum
step at unchanged tolerance does not establish convergence. Method is faster
than181.85 s tight RK4 on this diagnostic, but still slower than scalar7.199 s.

Run58 ACTIVE handle2605: same runtime18/model/candidate/.85 s, methoddop853,
rtol1e-12/atol1e-14/max_step1/720,budget100000; scalar1e-12/1e-14/.000125.
Driver /mnt/c/Users/diete/compare_native_manifold_replay_9967_58.py; output
/mnt/c/Users/diete/native-manifold-replay-9967-58. Poll original before restart.
All implementation through ae06e933b pushed; pre-push checks passed. Root also
independently ran the actual Pinocchio DOP853 noncommuting test successfully.
