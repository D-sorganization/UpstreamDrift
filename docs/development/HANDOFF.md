...
- Merge metadata: the concurrent merge retained two versions of our own #9920 SPEC row; CI rejected the duplicate. Kept the complete current row and preserved all peer rows; the unchanged SPEC checker now passes.
