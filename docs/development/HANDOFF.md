...
- Validation: `python -m pytest tests/unit/motion_matching/test_full_swing_qualification.py -q -n 0 --no-cov`
  ...
  `origin/main` after #10650 (#8887); jobs unit tests retained;
  SPEC keeps both #10707 and sibling rows.
...
- Next: Confirm CI green on #10707 after #10650 merge; do not start MS-106 or
