...
- **Neural Epic:** [#10603](https://github.com/D-sorganization/UpstreamDrift/issues/10603), 13 bounded children; NM-00 merged on main; NM-01 in flight on `feat/nm01-learning-tasks-freeze`.
- **Read:** [Shared Review](../plans/club_neural_review/REVIEW.md); [Club-Only Turnover](../plans/club_only_matching/TURNOVER.md); [Neural Turnover](../plans/neural_motion_matching/TURNOVER.md); [NM-00 Artifact Audit](../plans/neural_motion_matching/artifact_audit.md); [NM-01 Learning Tasks](../plans/neural_motion_matching/learning_tasks.md).
- **NM-00 state:** Fail-closed dataset/checkpoint/claim audit in `src/shared/python/neural_motion/` shipped via PR [#10668](https://github.com/D-sorganization/UpstreamDrift/pull/10668). Documented `TenThousandFiles.parquet` and default surrogate checkpoints remain absent/quarantined; no native training or speed claim.
- **NM-01 state:** Worktree `C:/Users/diete/Repositories/Worktrees/UpstreamDrift-10616-nm01`, branch `feat/nm01-learning-tasks-freeze`, PR [#10671](https://github.com/D-sorganization/UpstreamDrift/pull/10671), lease `local`/`nm01-cursor` on #10616. Frozen contracts: forward / inverse / masked-trajectory-to-controls tasks; TB-00-keyed `CheckpointDimensions` (no hard-coded 27×7); benefit experiment `neural-benefit-experiment/1.0.0` with five baselines, seven latency phases, pilot 100/500/2000 + three seeds, break-even fail-closed when savings ≤ 0. Evidence digest `7d93734cf5a5…`. Modules: `tasks.py`, `roster.py`, `experiment.py`. Tests: `test_learning_tasks.py`, `test_benefit_experiment.py` (24 passed). No training executed; compute caps pending timing probe. Checkpoint SELF.
- **Next:** Pass protected checks on [#10671](https://github.com/D-sorganization/UpstreamDrift/pull/10671), then dispatch [NM-02 #10617](https://github.com/D-sorganization/UpstreamDrift/issues/10617) (native dataset labels).
