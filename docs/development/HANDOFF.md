...
- Limits: protected application CI and exact installed-consumer launcher/calibration qualification remain pending. Lexical graphs are scoped navigation evidence; scientific/physical approval is separate. No subscription is needed. No peer-owned worktree was modified.
- Next: build and qualify the installed consumer at this committed pin, publish through normal hooks, require green protected CI, then reconcile the fleet delivery audit and epic.
