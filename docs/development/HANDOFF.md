...
- Validation: `python -m pytest tests/unit/motion_matching/test_simscape_candidate_convert.py -q`; `python scripts/ci/check_architecture_budget.py` (parameter-budget fix).
