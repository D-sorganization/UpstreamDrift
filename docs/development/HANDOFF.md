...
- **Ordered next:** (1) land MS-104 #10707 (2) drive CO-09 harden #10717 if still
  open (3) do not steal NM-07 #10622 (`claim:antigravity`) (4) after NM-07,
  start NM-08 #10623 (5) DeskComputer native Fit/G1 for unresolved club-only
...
- **Idle after merge:** NM-06 `…\UpstreamDrift-10621-nm06`; CO-10 survivor
  `…\UpstreamDrift-10614-co10-push` (#10720 merged); duplicate #10719 leave idle
...
- Baseline merged via PR [#10718](https://github.com/D-sorganization/UpstreamDrift/pull/10718)
  (`2f6e119ef`); survivor [#10720](https://github.com/D-sorganization/UpstreamDrift/pull/10720)
  also merged (runnable saved-job commands + architecture helper split).
  Duplicate #10719 stays closed. Issue #10614 closed. DL-#10614 shipped.
...
- Limitations: software-contract turnover only; `native_g1_pass` false;
  epic #10602 stays open for desk-native Fit/G1.
