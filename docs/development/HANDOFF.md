...
uses isolated APT source and package-index paths for both update and install.
...
Ruff and focused mypy pass. Local tests do not perform actual Linux installs;
