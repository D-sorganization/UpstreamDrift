function report = replay_returned103_r2025b(repo)
%REPLAY_RETURNED103_R2025B Qualified independent R2025b forward replay of returned103 (0-0.90s).
% Incorporates:
% 1. Qualified solver settings (ode15s, RelTol 1e-6, MaxStep 1/1440 s) demonstrating micro-meter parity
...
% 5. Compact MAT saving (< 1 MB) without Simulink simulation objects
    ...
    evidence_dir = fullfile(repo, 'docs', 'development', 'simscape_tour_matching', 'native_evidence', 'two_window_fit_9967_103');
    ...
    assert(abs(duration_s - 0.90) < 1e-4, 'Expected duration 0.90 s');
    ...
    % Qualified high-accuracy solver parameters
    ...
    report.qualification = 'qualified_r2025b_cold_replay_returned103';
    ...
    report.gates = struct( ...
        ...
        'gate3_terminal_rms_45mm', terminal_rms_m <= 0.045, ...
