function report = replay_returned85_r2025b(repo)
%REPLAY_RETURNED85_R2025B Independent R2025b forward replay of returned85.
...
% computes the 5 canonical metrics, and tests parity against Pinocchio replay.
    ...
    evidence_dir = fullfile(repo, 'docs', 'development', 'simscape_tour_matching', 'native_evidence', 'two_window_fit_9967_85');
    ...
    report.qualification = 'independent_r2025b_cold_replay_returned85';
    report.candidate_sha256 = 'c028972c791c8bb283f8d6228449c79a59da376782b6073e3c26af788b327e5e';
    ...
    report.pinocchio_metrics = struct( ...
        'whole_rms_m', 0.02276425636700179, ...
        'early_rms_m', 0.010798993874052327, ...
        'terminal_rms_m', 0.042696165856957444, ...
        'club_cluster_rms_m', 0.012440939527027581, ...
    ...
    fprintf('Whole RMS:       %.3f mm (Pinocchio: 22.764 mm)\n', whole_rms_m * 1000);
    fprintf('Early RMS:       %.3f mm (Pinocchio: 10.799 mm)\n', early_rms_m * 1000);
    fprintf('Terminal RMS:    %.3f mm (Pinocchio: 42.696 mm)\n', terminal_rms_m * 1000);
    fprintf('Club Cluster:    %.3f mm (Pinocchio: 12.441 mm)\n', club_cluster_rms_m * 1000);
