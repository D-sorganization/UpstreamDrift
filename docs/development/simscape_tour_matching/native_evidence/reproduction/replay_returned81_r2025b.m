function report = replay_returned81_r2025b(repo)
%REPLAY_RETURNED81_R2025B Independent R2025b forward replay of returned81.
...
% computes the 5 canonical metrics, and tests parity against Pinocchio replay.
    ...
    evidence_dir = fullfile(repo, 'docs', 'development', 'simscape_tour_matching', 'native_evidence', 'two_window_fit_9967_81');
    ...
    report.qualification = 'independent_r2025b_cold_replay_returned81';
    report.candidate_sha256 = 'dfafdff1cdec1a7fa15c41a34d41f054ef45d8a7df0a1faf8fab7898ab855776';
    ...
    report.pinocchio_metrics = struct( ...
        'whole_rms_m', 0.026366145791017086, ...
        'early_rms_m', 0.011426891719752063, ...
        'terminal_rms_m', 0.046305404518570306, ...
        'club_cluster_rms_m', 0.015955421510976068, ...
    ...
    fprintf('Whole RMS:       %.3f mm (Pinocchio: 26.366 mm)\n', whole_rms_m * 1000);
    fprintf('Early RMS:       %.3f mm (Pinocchio: 11.427 mm)\n', early_rms_m * 1000);
    fprintf('Terminal RMS:    %.3f mm (Pinocchio: 46.305 mm)\n', terminal_rms_m * 1000);
    fprintf('Club Cluster:    %.3f mm (Pinocchio: 15.955 mm)\n', club_cluster_rms_m * 1000);
    fprintf('Pelvis Yaw Err:  %.2f %%  (Pinocchio: 13.92 %%)\n', pelvis_yaw_error_pct);
