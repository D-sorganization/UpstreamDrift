function report = replay_returned87_r2025b(repo)
%REPLAY_RETURNED87_R2025B Independent R2025b forward replay of returned87.
...
% computes the 5 canonical metrics, and tests parity against Pinocchio replay.
    ...
    evidence_dir = fullfile(repo, 'docs', 'development', 'simscape_tour_matching', 'native_evidence', 'two_window_fit_9967_87');
    ...
    report.qualification = 'independent_r2025b_cold_replay_returned87';
    report.candidate_sha256 = 'ad92fe5e2faa863dad86d8bfd5166b5b3b8668e54e85cfaae625f8ea19c69a05';
    ...
    report.pinocchio_metrics = struct( ...
        'whole_rms_m', 0.02182998518372115, ...
        'early_rms_m', 0.01047521230424093, ...
        'terminal_rms_m', 0.039443582199717525, ...
        'club_cluster_rms_m', 0.007230198104266952, ...
        'pelvis_yaw_error_pct', 15.614408945800317);
    ...
    fprintf('Whole RMS:       %.3f mm (Pinocchio: 21.830 mm)\n', whole_rms_m * 1000);
    fprintf('Early RMS:       %.3f mm (Pinocchio: 10.475 mm)\n', early_rms_m * 1000);
    fprintf('Terminal RMS:    %.3f mm (Pinocchio: 39.444 mm)\n', terminal_rms_m * 1000);
    fprintf('Club Cluster:    %.3f mm (Pinocchio: 7.230 mm)\n', club_cluster_rms_m * 1000);
    fprintf('Pelvis Yaw Err:  %.2f %%  (Pinocchio: 15.61 %%)\n', pelvis_yaw_error_pct);
