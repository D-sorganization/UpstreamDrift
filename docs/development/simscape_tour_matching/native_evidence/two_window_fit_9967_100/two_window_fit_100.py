"""Bounded two-window direct-node SLSQP continuation 100 from returned run99.
...
def main() -> None:
    ...
    parser.add_argument("--terminal-weight", type=float, default=105.0)
    ...
    try:
        ...
        assert receipt["restart_roundoff"]["max_abs_increment_outside_box"] <= 1e-7
