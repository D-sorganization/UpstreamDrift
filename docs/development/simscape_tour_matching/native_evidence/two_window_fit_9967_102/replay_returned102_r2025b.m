...
% 5. Compact MAT saving (< 1 MB) without Simulink simulation objects
    ...
    evidence_dir = fullfile(repo, 'docs', 'development', 'simscape_tour_matching', 'native_evidence', 'two_window_fit_9967_102');
    ...
    report.qualification = 'qualified_r2025b_cold_replay_returned102';
