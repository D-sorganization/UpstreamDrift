"""Bounded two-window direct-node SLSQP continuation 87 from returned run86.

Single documented factor changes versus run86: restart recenters on returned86
(fb8fab93...), node bound maintained at 0.075 (safely respecting chart radius 0.5
...
def main() -> None:
    ...
    parser.add_argument("--max-nfev", type=int, default=135)
    parser.add_argument("--node-bound", type=float, default=0.075)
    parser.add_argument("--box-factor", type=float, default=5.0)
    parser.add_argument("--terminal-weight", type=float, default=15.0)
