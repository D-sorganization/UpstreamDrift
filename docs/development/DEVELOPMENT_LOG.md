...
- **Started:** 2026-09-13
- **Last verified:** 2026-09-14 (SELF; AN-1 full driver run on the anthropometric document: address 2.1 mm neutral, non-head IK 26.2 mm equal to qualified, backswing root error 5 mm; continuity and spin-prior solver additions; unit tests in the touched files pass)
...
- **Next step:** Choose and test-first implement the structural lever for the head and arms (neck joint or thoracic flexibility) as a coordinate-set change with a Simscape parity plan, per REVIEW.md section 9.1.
