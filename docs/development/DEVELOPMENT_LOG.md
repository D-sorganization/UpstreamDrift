...
- **Started:** 2026-09-13
- **Last verified:** 2026-09-14 (SELF; wrist cock axis on the elbow axis, setup elbow and scapula windows, CoM overlay, cross-engine setup parity Pinocchio 9e-16 m / Drake 6.5e-06 m; IK 30.4 mm all markers; unit tests in the touched files pass)
