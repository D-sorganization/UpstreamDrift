...
- **Branch:** feat/10156-receipt-schema
- **PR:** #10092 (FB-5, #10069); #10090 (Step 3 merged); #10089 (FB-4, #10068 merged); #10203 (Step 4 cross-engine replays merged); #10218 (HO-1 #10155 merged)
- **Paths:** docs/development/full_body_models; src/shared/python/motion_matching/full_body_spec.py; src/shared/python/motion_matching/contact_law.py; src/shared/python/motion_matching/tour_capture_contract.py; src/shared/python/motion_matching/marker_calibration.py; src/shared/python/motion_matching/full_body_ik.py; src/shared/python/motion_matching/visual_skeleton.py; src/shared/python/motion_matching/derivative_resolution.py; src/shared/python/motion_matching/full_body_forward_dynamics.py; src/shared/python/motion_matching/pipeline; tests/unit/motion_matching/pipeline; tests/unit/motion_matching; tests/unit/tools
- **Started:** 2026-09-13
- **Last verified:** 2026-09-16 (SELF; HO-7 #10161 design decisions record created in docs/development/full_body_models/DESIGN_DECISIONS.md; structured parser, validator with DbC contracts, and full unit test suite test_design_decisions.py passing 4 tests; title capitalization and prettier checks clean)
- **Summary:** Full-body pipeline handoff (epic #10162). HO-0 (#10186) landed the visual-layer reconciliation. HO-1 (#10155) migrated the ground-support pipeline under `src/shared/python/motion_matching/pipeline/`. HO-2 (#10156) established the Pydantic V2 receipt schema and validator (`receipt_schema.py`). HO-7 (#10161) consolidated all seventeen sections of findings in `evidence/anthropometry/REVIEW.md` into the authoritative design-decision record `docs/development/full_body_models/DESIGN_DECISIONS.md`, detailing 14 decisions (what, why, evidence receipts, rejected alternatives, and links) with structured parsing and validation utilities in `design_decisions.py`.
- **Next step:** Land HO-7 PR, then proceed to HO-3 (#10157 MJX environment and JAX-gated tests).
- **Evidence:** docs/development/full_body_models/DESIGN_DECISIONS.md, src/shared/python/motion_matching/pipeline/design_decisions.py, tests/unit/motion_matching/pipeline/test_design_decisions.py.
