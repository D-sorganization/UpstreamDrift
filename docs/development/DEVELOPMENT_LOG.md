...
- **Started:** 2026-09-13
- **Last verified:** 2026-09-14 (SELF; MM-7 compliant sole and tracked reference adopted (driver root error 38 mm through impact, was 178); cart-table dynamics filter implemented and receipted as not adopted (driver replay 497 mm); unit tests pass)
...
- **Next step:** MM-7b (#10109): implement the FB-5 contact-aware shooting fit: optimise the tracked reference under the replay's own contact dynamics (marker error of the replayed motion plus a zero-moment-point penalty), starting from the compliant-sole driver replay (38 mm root error) and receipting every iteration.
