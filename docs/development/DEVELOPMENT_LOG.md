...
- **Next step:** MM-7b (#10109): make the MJX plant's follow-through faithful (the soft grip weld diverges after 1.6 s: try locking the club to the lead hand after impact or a stiffer weld with more substeps, port-check against the shared plant's 130 mm late window), then run mjx_trajectory_optimisation.py over the full horizon and validate the whole-swing replay against 74.6 mm.
