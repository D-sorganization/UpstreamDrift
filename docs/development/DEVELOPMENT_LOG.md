...
- **Started:** 2026-09-13
- **Last verified:** 2026-09-14 (SELF; marker-driven elbow pits per frame, grip roll parameter and scan, club mesh epic #10120; driver IK 26.0 mm, 7-iron 24.1 mm; unit tests pass)
...
- **Next step:** MM-2 (#10104): the grip roll is not the lever (0 deg best of -90..+90, still 122 deg of lead cock beyond range); examine the rigid two-hand closure weld (free the trail hand's roll on the grip or fit the weld from the address) so the lead wrist stops absorbing 120 deg of cock, then impose the wrist and forearm ranges and rerun both captures.
