...
- **Started:** 2026-09-07
- **Last verified:** 2026-09-07 (Windows, Python 3.13.3, pytest 9.0.3)
- **Summary:** `provider: tools` entries in `src/config/models.yaml` and
  ...
  `python -m pytest tests/config/test_tile_paths_resolve.py` — 90 items,
  0 failures, 5 external-surface skips.
