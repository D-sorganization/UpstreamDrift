...
- **Branch:** feat/10250-rebuild-anthro-de-leva
- **PR:** #10092 (FB-5, #10069); #10090 (Step 3 merged); #10089 (FB-4, #10068 merged); #10203 (Step 4 cross-engine replays merged); #10218 (HO-1 #10155 merged); #10224 (HO-2 #10156 merged); #10235 (HO-7 #10161 merged); #10236 (HO-4 #10158 merged); #10249 (HO-9 #10111 merged); #10228 (HO-3 #10157 merged)
- **Paths:** docs/development/full_body_models; src/shared/python/motion_matching/full_body_spec.py; src/shared/python/motion_matching/contact_law.py; src/shared/python/motion_matching/tour_capture_contract.py; src/shared/python/motion_matching/marker_calibration.py; src/shared/python/motion_matching/full_body_ik.py; src/shared/python/motion_matching/visual_skeleton.py; src/shared/python/motion_matching/derivative_resolution.py; src/shared/python/motion_matching/full_body_forward_dynamics.py; src/shared/python/motion_matching/anthropometry.py; src/shared/python/motion_matching/pipeline; src/tools/motion_matching; tests/unit/motion_matching/pipeline; tests/unit/motion_matching; tests/unit/tools; tests/tools/motion_matching; scripts/config/mjx_env_pins.json; scripts/setup_mjx_env.ps1; scripts/setup_mjx_env.sh; tests/unit/motion_matching/test_document_freshness.py
- **Started:** 2026-09-13
- **Last verified:** 2026-09-16 (SELF; HO-11 #10250 rebuilt anthropometric documents and ground-support receipts with freshness test; verified 0.000 mm shift between HEAD spec and rebuilt spec; document freshness and receipt schema validation pass)
- **Summary:** Full-body pipeline handoff (epic #10162). HO-11 (#10250) rebuilt anthropometric documents (`full_body_spec_anthro_driver.json`, `full_body_spec_anthro_iron7.json`) and ground-support receipts (`docs/development/full_body_models/evidence/ground_support/anthro_driver/receipt.json`, `anthro_iron/receipt.json`) following HO-9 de Leva table corrections. Implemented `tests/unit/motion_matching/test_document_freshness.py` asserting segment coverage and table SHA-256 (`7e930d22...`). Verified that kinematics and dynamics shift between unedited HEAD spec and rebuilt spec is 0.000 mm across both driver and iron. Updated `receipt_schema.py` and regenerated `docs/development/full_body_models/RECEIPTS.md`.
- **Next step:** Land HO-11 PR, then proceed to HO-8 (#10108 hip zero-twist calibration), HO-12 (#10251), HO-10 (#10160), HO-5 (#10159), and HO-6 (#10121) in epic #10162.
- **Evidence:** tests/unit/motion_matching/test_document_freshness.py, docs/development/full_body_models/evidence/ground_support/anthro_driver/receipt.json, docs/development/full_body_models/evidence/ground_support/anthro_iron/receipt.json.
