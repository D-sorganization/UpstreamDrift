...
- **Started:** 2026-09-13
- **Last verified:** 2026-09-17 (SELF; MS-03 #10324 reconciled headline tour numbers with primary receipts on main; established canonical calibrated reference runs anthro_driver_shoot_g025 and anthro_iron_zmp vs primary uncalibrated baselines anthro_driver and anthro_iron; generated CANONICAL_RUN.md and bisect_receipt.json; added test_handoff_numbers_match_receipts.py)
- **Summary:** Full-body pipeline handoff (epic #10162, matched-swing program epic #10363). MS-03 (#10324) reconciled headline tour numbers with primary receipts on main, attributing the 27.3 mm to 52.3 mm shift to omission of `--static-seeds` during HO-8 regeneration, formally designated canonical calibrated reference runs vs primary uncalibrated baselines, documented the factor bisect in `CANONICAL_RUN.md` and `bisect_receipt.json`, and added `test_handoff_numbers_match_receipts.py`.
- **Next step:** Proceed to MS-06 (#10327) matched-swing program tracker doc and status generator.
- **Evidence:** docs/development/full_body_models/evidence/ground_support/CANONICAL_RUN.md, docs/development/full_body_models/evidence/ground_support/bisect_receipt.json, tests/unit/motion_matching/test_handoff_numbers_match_receipts.py.
