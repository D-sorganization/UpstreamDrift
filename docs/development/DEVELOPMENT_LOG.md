...
- **Started:** 2026-09-13
- **Last verified:** 2026-09-14 (SELF; AN-1 iteration 1: anthropometric native geometry builder with static-trial marker placement, marker weights and IK restarts; posture acceptance met, body-marker swing RMS 28.9 mm vs 26.2 mm qualified; unit tests in the touched files pass)
...
- **Next step:** Record the full driver run on full_body_spec_anthro_v1.json in evidence/ground_support/anthro_v1/receipt.json and pick the structural lever for the remaining arm and trunk residual (neck joint, thoracic flexibility) per REVIEW.md section 9.
