...
- **Started:** 2026-09-13
- **Last verified:** 2026-09-14 (SELF; ground-support evidence: address 3 mm, full-capture reference 28.5 mm with planted feet, tracked backswing root within 14 mm; downswing diverges; 27 new unit tests pass)
...
- **Next step:** Derive stance timing from the reference contact forces and re-run docs/development/full_body_models/evidence/ground_support/run_ground_support.py to see whether the downswing root error at 1.3 s drops below 0.05 m.
