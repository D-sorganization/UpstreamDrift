...
- **Next step:** Open the PR with `Refs #8869` (partial: core silent-no-op defect and dead `file_pubsub.py` resolved; #8868 training-pair wiring and channel-hint auto-routing remain open follow-ups), await green CI, merge, release lease.
