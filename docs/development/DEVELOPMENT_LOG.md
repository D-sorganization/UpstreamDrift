...
- **Next step:** Qualify opt-in grouped physical/sensitivity DOP853 error control on the exact failed68 candidate in diagnostic71 before any optimizer retry. Diagnostic70 fails narrowly at1.02308673e-7 m versus1e-7 gate; runtime70 passes49 focused/real Pinocchio tests. Fit68 is terminal1 after425.444 s: eight Jacobian checks pass, ninth fails marker agreement; no returned solution.57 local grouped/native/budget/runner regressions and Ruff pass after RED/GREEN.
