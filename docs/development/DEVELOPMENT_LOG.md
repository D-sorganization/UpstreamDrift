...
- **Started:** 2026-09-13
- **Last verified:** 2026-09-14 (SELF; ground-support program: shared ground/hip/scaling contracts, MuJoCo marker IK and computed-torque simulation, spec v2 axis fix; 24 new unit tests pass; GS-4 dynamics gate open)
...
- **Next step:** Close the GS-4 gate (ground-supported tracking of the consistent reference: weight fraction, CoP in polygon, root within 0.05 m) in docs/development/full_body_models/evidence/ground_support.
