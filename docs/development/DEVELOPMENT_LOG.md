...
- **PR:** #10092 (FB-5, #10069); #10090 (Step 3 merged); #10089 (FB-4, #10068 merged)
- **Paths:** docs/development/full_body_models; src/shared/python/motion_matching/full_body_spec.py; src/shared/python/motion_matching/contact_law.py; src/shared/python/motion_matching/tour_capture_contract.py; src/shared/python/motion_matching/marker_calibration.py; src/shared/python/motion_matching/full_body_ik.py; src/shared/python/motion_matching/visual_skeleton.py; src/shared/python/motion_matching/derivative_resolution.py; src/shared/python/motion_matching/full_body_forward_dynamics.py; src/shared/python/motion_matching/tour_metrics.py; src/engines/physics_engines/mujoco/python/visual_layer.py; src/engines/physics_engines/mujoco/python/full_body_mjcf.py; src/engines/physics_engines/mujoco/python/full_body_ik.py; src/engines/physics_engines/pinocchio/python/full_body_ik.py; src/engines/physics_engines/drake/python/full_body_ik.py; src/tools/tour_matching_viewer; docs/development/full_body_models/evidence/fb4_calibration; docs/development/full_body_models/evidence/fb5_matching; docs/development/full_body_models/evidence/viewer; tests/unit/motion_matching; tests/unit/tools
- **Started:** 2026-09-13
- **Last verified:** 2026-09-14 (SELF; FB-4 marker calibration and full-body IK verified on MuJoCo, Pinocchio, and Drake with receipts and .npz trajectories; Tour Matching Viewer launcher tile verified; FB-5 forward-dynamics matching verified on MuJoCo with derivative floor resolution, two-window shooting fit with shared_boundary_policy="once", uninterrupted 654-frame replay with 5 shared metrics and contact audit; 13 motion matching unit tests pass with Ruff/black/mypy; MJX differentiable trajectory optimisation verified in parallel ground-support lane)
- **Summary:** Shared full-body specification schema/validator with upper-body slice identity, shared ground-contact law with parity harness, full_body_spec_v1.json, MuJoCo full-body MJCF export with contact adapter (FB-3-M, #10066), Pinocchio full-body builder with spatial contact forces injected into weld-constrained dynamics (FB-3-P, #10065), Drake full-body URDF export and KKT weld adapter with shared contact (FB-3-D, #10067), shared visual skeleton layer with MuJoCo rendering and visuals handoff (#10087), alternating marker calibration and IK per engine for 34 tracked labels (FB-4, #10068), Tour Matching Viewer launcher tile (Step 3, #10090), and full-body forward-dynamics matching with two-window shooting fitter (FB-5, #10069) are implemented and verified; receipts and full 654-frame forward trajectories archived.
