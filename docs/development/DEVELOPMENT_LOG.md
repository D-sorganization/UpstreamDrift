...
- **State:** in_progress
- **Owner:** local
- **Issue:** #10188 (child #10194 active; children #10189–#10200)
- **Branch:** feat/issue-10194-session-service
- **PR:** #10215 (merged; GS-04 #10193); #10213 (merged; GS-03 #10192); #10208 (merged; GS-00 #10189, GS-01 #10190, GS-02 #10191); #10201 (merged; planning)
...
- **Started:** 2026-09-15
- **Last verified:** 2026-09-15 (SELF; GS-00, GS-01, GS-02, GS-03, GS-04, and GS-05 implemented test-first; 50 unit tests pass across golf_simulator; ruff check/format, black, mypy, architecture budget, and spec paths clean with 0 errors)
- **Summary:** GS-05 (#10194) shared golf session service and local reference destination implemented. GolfSessionService coordinates destination lifecycle, prepare/arm/cancel/submit policy, single-use arm tokens, context revision checking, and reconciliation of uncertain submissions. LocalReferenceAdapter wraps FlightSimulatorProtocol (BallFlightSimulator with EnhancedBallFlightSimulator fallback), computes RK4 ball trajectories with full provenance labeling, and maintains distinct trajectory and receipt contracts. shot_envelope_to_launch_conditions delivers bidirectional conversion parity. FakeSimulatorAdapter provides configurable test spy and fault injection. Service contract test suite validates adapter substitution and shot identity preservation.
- **Next step:** Open PR for GS-05 (#10194); proceed to GS-06 (#10195) replay and one-impact submission.
- **Evidence:** tests/unit/golf_simulator/test_session_service.py, tests/unit/golf_simulator/test_local_adapter.py, tests/unit/golf_simulator/test_service_contracts.py, tests/unit/golf_simulator/test_launch_bridge_reverse.py; docs/plans/golf_simulator_integration/README.md.
...
- **State:** in_progress
- **Owner:** claude
- **Issue:** #10062 (children #10063 to #10070); continued by epic #10162 (MM-1 to MM-10)
- **Branch:** feat/10062-visual-skeleton-layer
- **PR:** #10092 (FB-5, #10069); #10090 (Step 3 merged); #10089 (FB-4, #10068 merged); #10203 (Step 4 cross-engine replays merged)
- **Paths:** docs/development/full_body_models; src/shared/python/motion_matching/full_body_spec.py; src/shared/python/motion_matching/contact_law.py; src/shared/python/motion_matching/tour_capture_contract.py; src/shared/python/motion_matching/marker_calibration.py; src/shared/python/motion_matching/full_body_ik.py; src/shared/python/motion_matching/visual_skeleton.py; src/shared/python/motion_matching/derivative_resolution.py; src/shared/python/motion_matching/full_body_forward_dynamics.py; src/shared/python/motion_matching/tour_metrics.py; src/shared/python/motion_matching/replay_metrics.py; src/engines/physics_engines/mujoco/python/visual_layer.py; src/engines/physics_engines/mujoco/python/full_body_mjcf.py; src/engines/physics_engines/mujoco/python/full_body_ik.py; src/engines/physics_engines/pinocchio/python/full_body_ik.py; src/engines/physics_engines/drake/python/full_body_ik.py; src/tools/tour_matching_viewer; docs/development/full_body_models/evidence/fb4_calibration; docs/development/full_body_models/evidence/fb5_matching; docs/development/full_body_models/evidence/viewer; docs/development/full_body_models/evidence/replays; docs/development/full_body_models/evidence/ground_support; tests/unit/motion_matching; tests/unit/tools
- **Started:** 2026-09-13
- **Last verified:** 2026-09-15 (SELF; Step 4 cross-engine replays verified on MuJoCo, Pinocchio, and Drake with animated GIFs, standardized NPZ archives, and 5-metric parity table in receipt.json; test_returned81_cross_engine_replay.py passed with Ruff/black/mypy; FB-4 marker calibration and full-body IK verified on MuJoCo, Pinocchio, and Drake; Tour Matching Viewer launcher tile verified; FB-5 forward-dynamics matching verified on MuJoCo; MJX differentiable trajectory optimisation verified in parallel ground-support lane)
- **Summary:** Shared full-body specification schema/validator with upper-body slice identity, shared ground-contact law with parity harness, full_body_spec_v1.json, MuJoCo full-body MJCF export with contact adapter (FB-3-M, #10066), Pinocchio full-body builder with spatial contact forces injected into weld-constrained dynamics (FB-3-P, #10065), Drake full-body URDF export and KKT weld adapter with shared contact (FB-3-D, #10067), shared visual skeleton layer with MuJoCo rendering and visuals handoff (#10087), alternating marker calibration and IK per engine for 34 tracked labels (FB-4, #10068), Tour Matching Viewer launcher tile (Step 3, #10090), full-body forward-dynamics matching with two-window shooting fitter (FB-5, #10069), and same-input replays of Returned81 candidate across MuJoCo, Pinocchio, and Drake (Step 4, #10062) with animated GIFs and 5-metric cross-engine parity are implemented and verified; receipts and full 654-frame forward trajectories archived.
- **Next step:** Handoff epic #10162: HO-0 (#10186, expert) lands this branch on main first (22 post-#10087 commits, 22 conflicts with the parallel FB-4/5/6 lane, per-file rules in the issue); then cheap agents take HO-1 (#10155, pipeline package under src); the expert item is HO-5 (#10159): reconcile the MJX plant's pelvis yaw response with the shared simulator (integrator, contact evaluation point, armature), then optimise the full horizon and the 7-iron.
- **Evidence:** docs/development/full_body_models/HANDOFF.md, docs/development/full_body_models/VISUALS_HANDOFF.md, docs/development/full_body_models/evidence/replays/ (mujoco, pinocchio, drake gifs, receipts, npz replays, receipt.json), docs/development/full_body_models/evidence/fb4_calibration/ (mujoco, pinocchio, drake receipts and trajectories), docs/development/full_body_models/evidence/fb5_matching/ (mujoco receipt and forward trajectory), docs/development/full_body_models/evidence/viewer/receipt.json, docs/development/full_body_models/evidence/ground_support/anthro_driver/receipt.json, tests/unit/motion_matching/test_derivative_resolution.py, tests/unit/motion_matching/test_multi_shooting_fit.py, tests/unit/motion_matching/test_full_body_forward_dynamics.py, tests/unit/motion_matching/test_full_body_marker_calibration.py, tests/unit/tools/test_tour_matching_viewer_core.py, tests/unit/tools/test_tour_matching_viewer_adapter.py, tests/unit/motion_matching/test_returned81_cross_engine_replay.py.
