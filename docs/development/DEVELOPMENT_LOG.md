...
- **Next step:** Inspect active bounds and enforce intermediate-sample closure after scaled receipt retracted_tracking_9967_30.json; preserve markers and q0/qd0.
