...
- **Started:** 2026-09-25
- **Last verified:** 2026-09-26 — CI gate fixes (stub guard, LOD, architecture budget) verified locally: `check_architecture_budget.py` OK, `check_lod.py src` clean; motion_matching + neural_motion + browser + opensim junit 2379 tests, 16 failures, none new vs origin/main (5 fewer).
