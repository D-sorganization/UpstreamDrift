...
- **Owner:** antigravity
- **Issue:** #8766
- **Branch:** fix/8766-burndown-headless-tests-32
- **PR:** #10024
...
- **Summary:** Progressive burndown of the quarantine ledger (#8766). Prior tranches retired 43 packaging/governance tests (#10010), 11 deployment tests (#10012), 57 bunker shot and API route tests (#10013), and 29 shared Python / physics tests (#10015). This tranche burns down 32 quarantined headless tests across shared Python, AI adapters (Gemini, Ollama), motion pipeline, security, and setup wizard, ratcheting debt from 379 to 347.
