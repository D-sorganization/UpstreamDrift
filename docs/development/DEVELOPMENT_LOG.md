...
- **Next step:** Handoff epic #10162: cheap agents take HO-1 (#10155, pipeline package under src) first; the expert item is HO-5 (#10159): reconcile the MJX plant's pelvis yaw response with the shared simulator (integrator, contact evaluation point, armature), then optimise the full horizon and the 7-iron.
