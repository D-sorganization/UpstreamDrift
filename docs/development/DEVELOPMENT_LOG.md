...
- **Started:** 2026-09-19
- **Last verified:** 2026-09-21 at SELF — rebased onto origin/main; extracted `_margin_violation`/`_finalize_redistribution` helpers for DRY gate; focused PF-06 unit suites pending local re-run after conflict resolution.
...
- **Next step:** Confirm focused PF-06 tests pass on the rebased branch, then push PR #10504 with force-with-lease.
