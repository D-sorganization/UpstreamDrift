...
- **Started:** 2026-09-13
- **Last verified:** 2026-09-16 (SELF; HO-3 #10157 MJX environment setup, pure JAX functions with SiteState/WeldGains parameter tuples, and 6 JAX-gated unit tests verified; contact law parity < 1e-6 N against shared law; clean skips in standard env, passes in ~/.venv-mjx)
...
- **Next step:** Land HO-3 PR (#10228), then proceed to HO-11 (#10250 anthropometric document rebuild and freshness gate) before any new receipts, followed by HO-8 (#10108), HO-12 (#10251), HO-10 (#10160), HO-5 (#10159), and HO-6 (#10121) in epic #10162.
- **Evidence:** tests/unit/motion_matching/test_mjx_optimisation.py, scripts/config/mjx_env_pins.json, scripts/setup_mjx_env.ps1, scripts/setup_mjx_env.sh, docs/development/full_body_models/evidence/ground_support/mjx_trajectory_optimisation.py.
