...
- **Next step:** Enforce initial velocity and scale closure constraints after marker-aware receipt retracted_tracking_9967_28.json; see HANDOFF Current Bound-Audit Correction (SELF).
