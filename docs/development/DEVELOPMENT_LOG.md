...
- **Branch:** feat/10108-hip-zero-twist
- **PR:** #10092 (FB-5, #10069); #10090 (Step 3 merged); #10089 (FB-4, #10068 merged); #10203 (Step 4 cross-engine replays merged); #10218 (HO-1 #10155 merged); #10224 (HO-2 #10156 merged); #10235 (HO-7 #10161 merged); #10236 (HO-4 #10158 merged); #10249 (HO-9 #10111 merged); #10228 (HO-3 #10157 merged); #10261 (HO-11 #10250 merged)
...
- **Started:** 2026-09-13
- **Last verified:** 2026-09-16 (SELF; HO-8 #10108 hip zero-twist calibration and unwidened leg bounds BOUND_WIDENING=1.0 verified; 0 leg range_of_motion_flags on IK reference across both driver and iron; verify_setup_parity passed across MuJoCo, Drake, and Pinocchio; 7 unit tests in test_hip_calibration.py passed; HO-11 document freshness passed)
- **Summary:** Full-body pipeline handoff (epic #10162). HO-8 (#10108, MM-6) calibrated the hip coordinate zero-twist angle from capture using knee medial markers or ankle fallback plane normal, rotated the hip joint coordinate zero via parent_to_base post-multiplication, unwidened leg joint range bounds to 1.0x (BOUND_WIDENING = 1.0 in pipeline/constants.py), eliminated lower-limb range-of-motion flags in the IK reference across both captures (driver and iron), and verified cross-engine setup parity across MuJoCo, Drake, and Pinocchio. Reconciled with HO-11 (#10250) document freshness tests and table hash validation.
- **Next step:** Land HO-8 PR, release lease, then proceed to HO-12 (#10251), HO-10 (#10160), HO-5 (#10159), and HO-6 (#10121) in epic #10162.
- **Evidence:** tests/unit/motion_matching/test_hip_calibration.py, tests/unit/motion_matching/test_document_freshness.py, docs/development/full_body_models/evidence/ground_support/anthro_driver/receipt.json, docs/development/full_body_models/evidence/ground_support/anthro_driver_shoot/receipt.json, docs/development/full_body_models/evidence/ground_support/anthro_iron/receipt.json, docs/development/full_body_models/evidence/ground_support/anthro_iron_shoot/receipt.json, docs/development/full_body_models/evidence/setup_parity/receipt_anthro_driver.json.
