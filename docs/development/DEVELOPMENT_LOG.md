...
- **Next step:** Split physical closure-level derivative errors and verify step-size convergence for intermediate-sample receipt retracted_tracking_9967_31.json before further optimization.
