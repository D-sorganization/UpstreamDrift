...
| **Performance**             |                      |            |               |                    |
| Simulation Speed            | Baseline             | _Untested_ | ~20% slower\* | MuJoCo fastest     |
...
| --------------------- | --------------- | --------------- | ------------ |
| Simple Pendulum       | 1.0x (baseline) | _Needs testing_ | ~1.2x slower |
| Golf Swing            | _TBD_           | _TBD_           | _TBD_        |
| Contact (ball impact) | _TBD_           | _TBD_           | _TBD_        |
