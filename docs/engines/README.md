...
- **[MuJoCo](mujoco.md)**: fast, accurate physics engine suitable for contact-rich environments and reinforcement learning.
- **[Drake](drake.md)**: Focused on stability, model-based design, and rigorous verification.
