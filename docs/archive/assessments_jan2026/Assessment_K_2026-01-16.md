...
- **Weaknesses:**
  ...
  - **Provenance**: While logging is good, I didn't see a dedicated "Provenance" module that tracks _exactly_ which data/code/params produced a result (though `RecorderInterface` helps).
