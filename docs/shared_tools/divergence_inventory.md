...
| **Total** | **423** | **279** | **123** | **1425** | **709** | **702** |
...
| `ai/gui/assistant_panel.py` | -5889 |  | ? | ? |
...
| `gui_launcher/launcher_web.py` | -107 |  | ? | ? |
...
| `humanoid_character_builder/generators/_mesh_types.py` | +1917 |  | ? | ? |
...
| `humanoid_character_builder/generators/mesh_generator.py` | +380 |  | ? | ? |
...
| `humanoid_character_builder/mesh/collision_generator.py` | -6767 |  | ? | ? |
...
| Path | Δ bytes (UD−Tools) | Spelling-only | UD last touch | Tools last touch |
|---|---:|:---:|---|---|
| `import_aliases.py` | -1577 |  | ? | ? |

### Package `model_generation` (53 Diverged Files)

| Path | Δ bytes (UD−Tools) | Spelling-only | UD last touch | Tools last touch |
|---|---:|:---:|---|---|
| `model_generation/__init__.py` | +60 |  | ? | ? |
| `model_generation/_convenience.py` | +4 | yes | ? | ? |
| `model_generation/_lazy_map.py` | +546 |  | ? | ? |
| `model_generation/api/__init__.py` | +4 | yes | ? | ? |
| `model_generation/api/rest_api.py` | +1096 |  | ? | ? |
| `model_generation/api/rest_api_assets.py` | +206 |  | ? | ? |
| `model_generation/api/rest_api_core.py` | +4240 |  | ? | ? |
| `model_generation/api/rest_api_fastapi.py` | -27 |  | ? | ? |
| `model_generation/api/rest_api_flask.py` | -72 |  | ? | ? |
| `model_generation/api/rest_api_generation.py` | +306 |  | ? | ? |
| `model_generation/api/rest_api_support.py` | +457 |  | ? | ? |
| `model_generation/builders/__init__.py` | +25 |  | ? | ? |
| `model_generation/builders/base_builder.py` | +2060 |  | ? | ? |
| `model_generation/builders/manual_builder.py` | +16 | yes | ? | ? |
| `model_generation/builders/parametric_builder.py` | +10 |  | ? | ? |
| `model_generation/builders/urdf_writer.py` | +1597 |  | ? | ? |
...
| `model_generation/converters/mjcf_converter.py` | +1694 |  | ? | ? |
...
| `model_generation/converters/urdf_parser.py` | +7213 |  | ? | ? |
...
| `model_generation/core/types.py` | +652 |  | ? | ? |
| `model_generation/core/validation.py` | +21 |  | ? | ? |
| `model_generation/editor/__init__.py` | +12 | yes | ? | ? |
| `model_generation/editor/editor_clipboard.py` | +227 |  | ? | ? |
| `model_generation/editor/editor_modifications.py` | +2617 |  | ? | ? |
| `model_generation/editor/editor_types.py` | +1022 |  | ? | ? |
| `model_generation/editor/frankenstein_editor.py` | +330 |  | ? | ? |
| `model_generation/editor/text_editor_diff_mixin.py` | +591 |  | ? | ? |
| `model_generation/explorer/__init__.py` | -35 |  | ? | ? |
| `model_generation/explorer/model_explorer.py` | +12 | yes | ? | ? |
| `model_generation/export/__init__.py` | +438 |  | ? | ? |
| `model_generation/humanoid/__init__.py` | +251 |  | ? | ? |
| `model_generation/inertia/__init__.py` | +12 | yes | ? | ? |
| `model_generation/inertia/calculator.py` | +27 |  | ? | ? |
| `model_generation/inertia/primitives.py` | +317 |  | ? | ? |
| `model_generation/library/__init__.py` | +20 | yes | ? | ? |
| `model_generation/library/_rate_limiter.py` | +604 |  | ? | ? |
| `model_generation/library/cache.py` | +1744 |  | ? | ? |
| `model_generation/library/github_importer.py` | +8 | yes | ? | ? |
| `model_generation/library/model_library.py` | +242 |  | ? | ? |
| `model_generation/library/repository.py` | +4968 |  | ? | ? |
| `model_generation/library/unified_loader.py` | +25 |  | ? | ? |
| `model_generation/mesh/__init__.py` | +76 |  | ? | ? |
...
| Path | Δ bytes (UD−Tools) | Spelling-only | UD last touch | Tools last touch |
|---|---:|:---:|---|---|
| `realtime/__init__.py` | +1579 |  | ? | ? |
| `realtime/transport_file.py` | -2971 |  | ? | ? |
...
| `sidekick/calculators/electrical/glass_interface.py` | -9103 |  | ? | ? |
| `sidekick/calculators/thermo/steam_engine.py` | -983 |  | ? | ? |
...
| `sidekick/lab/bio/c3d_reader.py` | +0 |  | ? | ? |
...
| `sidekick/process_calculators/financial_calculator.py` | -311 |  | ? | ? |
| `sidekick/process_calculators/flare_calculator.py` | -463 |  | ? | ? |
...
| `sidekick/process_calculators/pressure_drop_calculator/pressure_drop_api.py` | +96 |  | ? | ? |
| `sidekick/process_calculators/pressure_drop_calculator/pressure_drop_interface.py` | -38 |  | ? | ? |
| `sidekick/process_calculators/pressure_drop_calculator/pressure_drop_results.py` | -5 |  | ? | ? |
| `sidekick/process_calculators/pressure_drop_calculator/pressure_drop_units.py` | -140 |  | ? | ? |
| `sidekick/process_calculators/pressure_drop_calculator/pressure_drop_validation.py` | +3 |  | ? | ? |
| `sidekick/process_calculators/pressure_drop_calculator/utils/flow_rate_converter.py` | +4 | yes | ? | ? |
| `sidekick/process_calculators/pressure_drop_calculator/utils/gas_properties.py` | -423 |  | ? | ? |
...
| `sidekick/tests/calculators/electrical/test_electrical_model.py` | -809 |  | ? | ? |
| `sidekick/tests/calculators/thermo/test_steam_engine.py` | +2 |  | ? | ? |
...
| `sidekick/ui/widgets/unit_aware_input.py` | -121 |  | ? | ? |
