...
**Insight goal:**  
Show _when_ the golfer is steering vs. _when the system is driving itself_.
...
**Key philosophy:**  
Power is about _who transfers energy to whom_, not just totals.
...
If a feature cannot explain _why_ something happens, it does not belong in the core.
