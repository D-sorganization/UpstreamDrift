...
| Config                   | Config ownership now split by class: runtime settings in `src/shared/python/config/`, domain YAML under owning packages, and CI policy in `scripts/config/` | #7216 |
