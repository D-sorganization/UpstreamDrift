...
`motion_matching/surrogate/perstep/train.py` and trial-split discipline from
`inverse_timestep/training.py`. Scheduler lookup remains
`training/runtime/runner_registry.py`.
