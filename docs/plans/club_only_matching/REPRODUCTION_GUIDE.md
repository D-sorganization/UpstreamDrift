...
- Matrix cells: 80 (scored=0, unresolved=80)
...
| -------------------------------- | ----------- | ----------------- | --------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `constrained_upper_body_golfer`  | `TW_wiffle` | `unqualified`     | desk-native / runtime owner | On DeskComputer with scipy_ode, run native Fit/G1 for constrained_upper_body_golfer×TW_wiffle and attach a receipt under docs/plans/club_only_matching/evidence/; do not invent native_g1_pass                                                                                       |
| `constrained_upper_body_golfer`  | `TW_ProV1`  | `unqualified`     | desk-native / runtime owner | On DeskComputer with scipy_ode, run native Fit/G1 for constrained_upper_body_golfer×TW_ProV1 and attach a receipt under docs/plans/club_only_matching/evidence/; do not invent native_g1_pass                                                                                        |
| `constrained_upper_body_golfer`  | `GW_wiffle` | `unqualified`     | desk-native / runtime owner | On DeskComputer with scipy_ode, run native Fit/G1 for constrained_upper_body_golfer×GW_wiffle and attach a receipt under docs/plans/club_only_matching/evidence/; do not invent native_g1_pass                                                                                       |
| `constrained_upper_body_golfer`  | `GW_ProV11` | `unqualified`     | desk-native / runtime owner | On DeskComputer with scipy_ode, run native Fit/G1 for constrained_upper_body_golfer×GW_ProV11 and attach a receipt under docs/plans/club_only_matching/evidence/; do not invent native_g1_pass                                                                                       |
| `driven_double_pendulum`         | `TW_wiffle` | `unqualified`     | desk-native / runtime owner | On DeskComputer with scipy_ode, run native Fit/G1 for driven_double_pendulum×TW_wiffle and attach a receipt under docs/plans/club_only_matching/evidence/; do not invent native_g1_pass                                                                                              |
| `driven_double_pendulum`         | `TW_ProV1`  | `unqualified`     | desk-native / runtime owner | On DeskComputer with scipy_ode, run native Fit/G1 for driven_double_pendulum×TW_ProV1 and attach a receipt under docs/plans/club_only_matching/evidence/; do not invent native_g1_pass                                                                                               |
| `driven_double_pendulum`         | `GW_wiffle` | `unqualified`     | desk-native / runtime owner | On DeskComputer with scipy_ode, run native Fit/G1 for driven_double_pendulum×GW_wiffle and attach a receipt under docs/plans/club_only_matching/evidence/; do not invent native_g1_pass                                                                                              |
| `driven_double_pendulum`         | `GW_ProV11` | `unqualified`     | desk-native / runtime owner | On DeskComputer with scipy_ode, run native Fit/G1 for driven_double_pendulum×GW_ProV11 and attach a receipt under docs/plans/club_only_matching/evidence/; do not invent native_g1_pass                                                                                              |
| `driven_triple_pendulum`         | `TW_wiffle` | `unqualified`     | desk-native / runtime owner | On DeskComputer with scipy_ode, run native Fit/G1 for driven_triple_pendulum×TW_wiffle and attach a receipt under docs/plans/club_only_matching/evidence/; do not invent native_g1_pass                                                                                              |
| `driven_triple_pendulum`         | `TW_ProV1`  | `unqualified`     | desk-native / runtime owner | On DeskComputer with scipy_ode, run native Fit/G1 for driven_triple_pendulum×TW_ProV1 and attach a receipt under docs/plans/club_only_matching/evidence/; do not invent native_g1_pass                                                                                               |
| `driven_triple_pendulum`         | `GW_wiffle` | `unqualified`     | desk-native / runtime owner | On DeskComputer with scipy_ode, run native Fit/G1 for driven_triple_pendulum×GW_wiffle and attach a receipt under docs/plans/club_only_matching/evidence/; do not invent native_g1_pass                                                                                              |
| `driven_triple_pendulum`         | `GW_ProV11` | `unqualified`     | desk-native / runtime owner | On DeskComputer with scipy_ode, run native Fit/G1 for driven_triple_pendulum×GW_ProV11 and attach a receipt under docs/plans/club_only_matching/evidence/; do not invent native_g1_pass                                                                                              |
| `full_body_drake`                | `TW_wiffle` | `unqualified`     | desk-native / runtime owner | On DeskComputer with Drake, run native Fit/G1 for full_body_drake×TW_wiffle and attach a receipt under docs/plans/club_only_matching/evidence/; do not invent native_g1_pass                                                                                                         |
| `full_body_drake`                | `TW_ProV1`  | `unqualified`     | desk-native / runtime owner | On DeskComputer with Drake, run native Fit/G1 for full_body_drake×TW_ProV1 and attach a receipt under docs/plans/club_only_matching/evidence/; do not invent native_g1_pass                                                                                                          |
| `full_body_drake`                | `GW_wiffle` | `unqualified`     | desk-native / runtime owner | On DeskComputer with Drake, run native Fit/G1 for full_body_drake×GW_wiffle and attach a receipt under docs/plans/club_only_matching/evidence/; do not invent native_g1_pass                                                                                                         |
| `full_body_drake`                | `GW_ProV11` | `unqualified`     | desk-native / runtime owner | On DeskComputer with Drake, run native Fit/G1 for full_body_drake×GW_ProV11 and attach a receipt under docs/plans/club_only_matching/evidence/; do not invent native_g1_pass                                                                                                         |
| `full_body_mujoco`               | `TW_wiffle` | `unqualified`     | desk-native / runtime owner | On DeskComputer with MuJoCo, run native Fit/G1 for full_body_mujoco×TW_wiffle and attach a receipt under docs/plans/club_only_matching/evidence/; do not invent native_g1_pass                                                                                                       |
| `full_body_mujoco`               | `TW_ProV1`  | `unqualified`     | desk-native / runtime owner | On DeskComputer with MuJoCo, run native Fit/G1 for full_body_mujoco×TW_ProV1 and attach a receipt under docs/plans/club_only_matching/evidence/; do not invent native_g1_pass                                                                                                        |
| `full_body_mujoco`               | `GW_wiffle` | `unqualified`     | desk-native / runtime owner | On DeskComputer with MuJoCo, run native Fit/G1 for full_body_mujoco×GW_wiffle and attach a receipt under docs/plans/club_only_matching/evidence/; do not invent native_g1_pass                                                                                                       |
| `full_body_mujoco`               | `GW_ProV11` | `unqualified`     | desk-native / runtime owner | On DeskComputer with MuJoCo, run native Fit/G1 for full_body_mujoco×GW_ProV11 and attach a receipt under docs/plans/club_only_matching/evidence/; do not invent native_g1_pass                                                                                                       |
...
| `full_body_pinocchio`            | `TW_wiffle` | `unqualified`     | desk-native / runtime owner | On DeskComputer with Pinocchio, run native Fit/G1 for full_body_pinocchio×TW_wiffle and attach a receipt under docs/plans/club_only_matching/evidence/; do not invent native_g1_pass                                                                                                 |
| `full_body_pinocchio`            | `TW_ProV1`  | `unqualified`     | desk-native / runtime owner | On DeskComputer with Pinocchio, run native Fit/G1 for full_body_pinocchio×TW_ProV1 and attach a receipt under docs/plans/club_only_matching/evidence/; do not invent native_g1_pass                                                                                                  |
| `full_body_pinocchio`            | `GW_wiffle` | `unqualified`     | desk-native / runtime owner | On DeskComputer with Pinocchio, run native Fit/G1 for full_body_pinocchio×GW_wiffle and attach a receipt under docs/plans/club_only_matching/evidence/; do not invent native_g1_pass                                                                                                 |
| `full_body_pinocchio`            | `GW_ProV11` | `unqualified`     | desk-native / runtime owner | On DeskComputer with Pinocchio, run native Fit/G1 for full_body_pinocchio×GW_ProV11 and attach a receipt under docs/plans/club_only_matching/evidence/; do not invent native_g1_pass                                                                                                 |
