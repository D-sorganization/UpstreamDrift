...
driven double/triple club-only fits, distinct fixed-pivot vs prescribed
moving-hub IDs with external-work accounting, separate in-plane/3D errors,
cold vs retrieval best-feasible retention, and replay packages with named
native blockers. Evidence:
...
merely a closed issue. Do not start CO-05 until CO-04 lands.
