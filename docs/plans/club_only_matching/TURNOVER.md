...
**CO-04 (#10608)** shipped via PR #10680. **CO-05 (#10609)** shipped via PR #10681.
**CO-06 (#10610)** is in progress on `feat/issue-10610-co06-control-replay`:
constrained ID/OC under declared actuation/contact, continuous Bernstein
policies, independent no-reset horizon replay, separated kinematic vs torque
status, and explicit ball-contact limitations (CHS/ball type are not force
...
**[#10610](https://github.com/D-sorganization/UpstreamDrift/issues/10610) (CO-06)
only** (CO-04/#10680 and CO-05/#10681 shipped). This is a dispatch-ready plan, not
...
merely a closed issue. Do not start CO-07 until CO-06 lands.
