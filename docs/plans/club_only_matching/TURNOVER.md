...
**CO-04 (#10608)** is in progress on `feat/10608-co04-pendulum-matching`: driven
double/triple pendulum matching across four canonical trials with in-plane vs 3D
residuals, exact-DOF retrieval warm-start, and moving-hub external-work accounting.
Evidence:
