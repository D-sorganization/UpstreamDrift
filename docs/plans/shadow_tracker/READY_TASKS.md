...
| C      | [#10139](https://github.com/D-sorganization/UpstreamDrift/issues/10139) | Implemented in Packet C Topic Branch                                                    | Convert existing camera types with explicit direction           |
