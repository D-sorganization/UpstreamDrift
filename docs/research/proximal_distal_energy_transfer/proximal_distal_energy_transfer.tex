...
\begin{tcolorbox}[enhanced jigsaw, titlerule=0mm, colback=white, colframe=quarto-callout-note-color-frame, opacityback=0, toprule=.15mm, breakable, arc=.35mm, opacitybacktitle=0.6, leftrule=.75mm, bottomtitle=1mm, left=2mm, toptitle=1mm, colbacktitle=quarto-callout-note-color!10!white, bottomrule=.15mm, rightrule=.15mm, coltitle=black, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Scope and Evidence Categories}]
...
\begin{tcolorbox}[enhanced jigsaw, titlerule=0mm, colback=white, colframe=quarto-callout-note-color-frame, opacityback=0, toprule=.15mm, breakable, arc=.35mm, opacitybacktitle=0.6, leftrule=.75mm, bottomtitle=1mm, left=2mm, toptitle=1mm, colbacktitle=quarto-callout-note-color!10!white, bottomrule=.15mm, rightrule=.15mm, coltitle=black, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Plain-language picture}]
