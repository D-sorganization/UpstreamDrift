...
## Description
The `efficiency_score` calculation in `src/shared/python/statistical_analysis.py` (`compute_swing_profile`) calculates "Input Work" by summing only *positive* power (concentric work).
