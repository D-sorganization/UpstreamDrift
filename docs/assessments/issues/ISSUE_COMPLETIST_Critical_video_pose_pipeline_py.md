# Critical Incomplete Implementation in video_pose_pipeline.py
...
## Description
The following critical incomplete implementations (stubs, placeholders, or NotImplementedError) were identified in `video_pose_pipeline.py`. These items block core functionality or represent significant technical debt in non-test code.

## Findings

| Line | Function/Context | Issue Type |
|------|------------------|------------|
| 385 | `_convert_poses_to_markers` | Stub |
