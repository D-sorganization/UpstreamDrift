...
3.  **Externalize**: Move these default values to a configuration file (`ball_profiles.json`) to emphasize that they are just _example_ values, not a hardcoded "truth" claimed by our software.
