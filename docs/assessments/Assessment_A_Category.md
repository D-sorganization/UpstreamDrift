# Assessment A Report: Architecture & Implementation
...
| File | Size (KB) |
|---|---|
| `vendor/ud-tools/src/data_processing/data_processor/python/data_processor/Data_Processor_r0.py` | 347.3 |
| `src/shared/python/ai/glossary_data_extended.py` | 124.6 |
| `vendor/ud-tools/src/tools/folder_tools/folder_tool/Folders_Tool_r0.py` | 122.6 |
| `vendor/ud-tools/src/data_processing/data_processor/python/data_processor/Data_Processor_Integrated.py` | 106.7 |
| `src/shared/python/ai/glossary_data_core.py` | 91.0 |
| `vendor/ud-tools/src/data_processing/data_processor/python/data_processor/ui/pyqt6/main_window.py` | 80.1 |
| `src/engines/physics_engines/drake/python/src/drake_gui_app.py` | 78.4 |
| `src/engines/physics_engines/pinocchio/python/pinocchio_golf/gui.py` | 70.7 |
| `src/engines/physics_engines/mujoco/head_models.py` | 64.9 |
| `vendor/ud-tools/src/tools/folder_tools/folder_packer_pro/folder_packer_pro.py` | 62.7 |
