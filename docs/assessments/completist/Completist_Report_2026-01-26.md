...
|---|---|---|---|
| 1 | `./src/engines/pendulum_models/JULES_ARCHITECTURE.md` | if grep -r "TODO\\|FIXME" --include="*.py" src/; then | 5/2/3 |
...
| 4 | `./src/engines/Simscape_Multibody_Models/3D_Golf_Model/JULES_ARCHITECTURE.md` | if grep -r "TODO\\|FIXME" --include="*.py" src/; then | 5/2/3 |
| 5 | `./src/engines/Simscape_Multibody_Models/2D_Golf_Model/JULES_ARCHITECTURE.md` | if grep -r "TODO\\|FIXME" --include="*.py" src/; then | 5/2/3 |
| 6 | `./src/engines/physics_engines/pinocchio/JULES_ARCHITECTURE.md` | if grep -r "TODO\\|FIXME" --include="*.py" src/; then | 5/2/3 |
| 7 | `./src/engines/physics_engines/pinocchio/tools/matlab_utilities/README.md` | - TODO, FIXME, HACK, XXX placeholders | 5/2/3 |
| 8 | `./src/engines/physics_engines/drake/JULES_ARCHITECTURE.md` | if grep -r "TODO\\|FIXME" --include="*.py" src/; then | 5/2/3 |
| 9 | `./src/engines/physics_engines/drake/tools/matlab_utilities/README.md` | - TODO, FIXME, HACK, XXX placeholders | 5/2/3 |
| 10 | `./src/engines/physics_engines/mujoco/JULES_ARCHITECTURE.md` | if grep -r "TODO\\|FIXME" --include="*.py" src/; then | 5/2/3 |
