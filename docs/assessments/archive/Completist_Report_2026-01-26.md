...
| `./src/engines/pendulum_models/JULES_ARCHITECTURE.md`                                                                                          | if grep -r "TODO\\                                                                     | FIXME" --include="\*.py" src/; then | TODO |
...
| `./src/engines/Simscape_Multibody_Models/3D_Golf_Model/JULES_ARCHITECTURE.md`                                                                  | if grep -r "TODO\\                                                                     | FIXME" --include="\*.py" src/; then | TODO |
| `./src/engines/Simscape_Multibody_Models/2D_Golf_Model/JULES_ARCHITECTURE.md`                                                                  | if grep -r "TODO\\                                                                     | FIXME" --include="\*.py" src/; then | TODO |
| `./src/engines/physics_engines/pinocchio/JULES_ARCHITECTURE.md`                                                                                | if grep -r "TODO\\                                                                     | FIXME" --include="\*.py" src/; then | TODO |
| `./src/engines/physics_engines/pinocchio/tools/matlab_utilities/README.md`                                                                     | - TODO, FIXME, HACK, XXX placeholders                                                  | TODO                                |
| `./src/engines/physics_engines/drake/JULES_ARCHITECTURE.md`                                                                                    | if grep -r "TODO\\                                                                     | FIXME" --include="\*.py" src/; then | TODO |
| `./src/engines/physics_engines/drake/tools/matlab_utilities/README.md`                                                                         | - TODO, FIXME, HACK, XXX placeholders                                                  | TODO                                |
| `./src/engines/physics_engines/mujoco/JULES_ARCHITECTURE.md`                                                                                   | if grep -r "TODO\\                                                                     | FIXME" --include="\*.py" src/; then | TODO |
...
| `./src/tools/matlab_utilities/scripts/matlab_quality_check.py`             | 75   | (r"\bFIXME\b", "FIXME placeholder found"),           | FIXME |
| `./src/tools/matlab_utilities/scripts/matlab_quality_check.py`             | 76   | (r"\bHACK\b", "HACK comment found"),                 | HACK  |
| `./src/tools/matlab_utilities/scripts/matlab_quality_check.py`             | 77   | (r"\bXXX\b", "XXX comment found"),                   | XXX   |
...
|---|---|---|---|
| 1 | `./src/engines/pendulum_models/JULES_ARCHITECTURE.md` | if grep -r "TODO\\|FIXME" --include="_.py" src/; then | 5/2/3 |
| 2 | `./src/engines/pendulum_models/tools/matlab_utilities/README.md` | - TODO, FIXME, HACK, XXX placeholders | 5/2/3 |
| 3 | `./src/engines/Simscape_Multibody_Models/3D_Golf_Model/matlab_utilities/README.md` | - TODO, FIXME, HACK, XXX placeholders | 5/2/3 |
| 4 | `./src/engines/Simscape_Multibody_Models/3D_Golf_Model/JULES_ARCHITECTURE.md` | if grep -r "TODO\\|FIXME" --include="_.py" src/; then | 5/2/3 |
| 5 | `./src/engines/Simscape_Multibody_Models/2D_Golf_Model/JULES_ARCHITECTURE.md` | if grep -r "TODO\\|FIXME" --include="_.py" src/; then | 5/2/3 |
| 6 | `./src/engines/physics_engines/pinocchio/JULES_ARCHITECTURE.md` | if grep -r "TODO\\|FIXME" --include="_.py" src/; then | 5/2/3 |
| 7 | `./src/engines/physics_engines/pinocchio/tools/matlab_utilities/README.md` | - TODO, FIXME, HACK, XXX placeholders | 5/2/3 |
| 8 | `./src/engines/physics_engines/drake/JULES_ARCHITECTURE.md` | if grep -r "TODO\\|FIXME" --include="_.py" src/; then | 5/2/3 |
| 9 | `./src/engines/physics_engines/drake/tools/matlab_utilities/README.md` | - TODO, FIXME, HACK, XXX placeholders | 5/2/3 |
| 10 | `./src/engines/physics_engines/mujoco/JULES_ARCHITECTURE.md` | if grep -r "TODO\\|FIXME" --include="_.py" src/; then | 5/2/3 |
| 11 | `./src/engines/Simscape_Multibody_Models/3D_Golf_Model/matlab/src/apps/golf_gui/Simscape Multibody Data Plotters/Python Version/golf_gui_r0/golf_visualizer_implementation.py` | \_calculate_scaling_factors | 5/2/4 |
| 12 | `./src/engines/Simscape_Multibody_Models/3D_Golf_Model/matlab/src/apps/golf_gui/Simscape Multibody Data Plotters/Python Version/golf_gui_r0/golf_visualizer_implementation.py` | \_compile_ground_shaders | 5/2/4 |
| 13 | `./src/engines/Simscape_Multibody_Models/3D_Golf_Model/matlab/src/apps/golf_gui/Simscape Multibody Data Plotters/Python Version/golf_gui_r0/golf_visualizer_implementation.py` | \_create_sphere_geometry | 5/2/4 |
| 14 | `./src/engines/Simscape_Multibody_Models/3D_Golf_Model/matlab/src/apps/golf_gui/Simscape Multibody Data Plotters/Python Version/golf_gui_r0/golf_visualizer_implementation.py` | \_create_club_geometry | 5/2/4 |
| 15 | `./src/engines/Simscape_Multibody_Models/3D_Golf_Model/matlab/src/apps/golf_gui/Simscape Multibody Data Plotters/Python Version/golf_gui_r0/golf_visualizer_implementation.py` | \_create_arrow_geometry | 5/2/4 |
| 16 | `./src/engines/Simscape_Multibody_Models/3D_Golf_Model/matlab/src/apps/golf_gui/Simscape Multibody Data Plotters/Python Version/golf_gui_r0/golf_visualizer_implementation.py` | \_setup_lighting | 5/2/4 |
| 17 | `./src/engines/Simscape_Multibody_Models/3D_Golf_Model/matlab/src/apps/golf_gui/Simscape Multibody Data Plotters/Python Version/integrated_golf_gui_r0/golf_gui_application.py` | \_on_position_changed | 5/2/4 |
| 18 | `./src/engines/physics_engines/pendulum/python/pendulum_physics_engine.py` | forward | 5/2/4 |
| 19 | `./src/engines/physics_engines/mujoco/python/humanoid_launcher.py` | set_analysis_config | 5/2/4 |
| 20 | `./src/engines/physics_engines/mujoco/python/humanoid_launcher.py` | load_config | 5/2/4 |
